...
![R permutation test to detect non-linearity of coinfection with the refinement of bin width and position of dataset grouping](images/coinfection.png){fig-alt="Local shrink/expand around the promising bin. Point fill = exact p-value; size = total n per bin"}
